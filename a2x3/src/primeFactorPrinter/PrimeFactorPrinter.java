...
public class PrimeFactorPrinter {
    ...
    public void printFactorization( long number ){
        System.out.printf("%d = ", number);  //Startnummer wird ausgegeben
        
        //Deklaration
        long primeFactorCandidate = 2; 
        long remainingNumber;
        remainingNumber = number;
        
        while (remainingNumber > 1) {
            while (remainingNumber % primeFactorCandidate == 0) {
                remainingNumber = remainingNumber/primeFactorCandidate;
                
                if (remainingNumber > 1) {
                    System.out.printf("%d*", primeFactorCandidate);
                } else {
                    System.out.printf("%d", primeFactorCandidate);
                }
            }  
